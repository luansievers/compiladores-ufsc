...
public class PrintTree {
	...
	// ------------------------- comando while -----------------------
    public void numberWhileNode(WhileNode x) {//ok
        if (x == null) {
            return;
        }
	...
	// ------------------------- comando dowhile -----------------------
    public void numberDoWhileNode(DoWhileNode x) {//ok
        if (x == null) {
            return;
        }
	...
	// ------------------------- comando switch -----------------------
    public void numberSwitchNode(SwitchNode x) {//ok
        if (x == null) {
            return;
        }

        x.number = kk++;
		numberSwitchCaseListNode(x.switchcases);
    }
    ...
    public void printSwitchNode(SwitchNode x) {
        ...
        System.out.println();
        System.out.print(x.number + ": SwitchNode ===> " + x.name.image + " " +
            ((x.switchcases == null) ? "null" : String.valueOf(x.switchcases.number)));
			
		printSwitchCaseListNode(x.switchcases);

    }
	
	// ------------- lista de cases --------------------------
    public void numberSwitchCaseListNode(ListNode x) {//ok
        if (x == null) {
            return;
        }

        x.number = kk++;
        numberSwitchCaseNode((SwitchCaseNode) x.node);
    ...
    public void printSwitchCaseListNode(ListNode x) {
        ...
        printSwitchCaseNode((SwitchCaseNode) x.node);
        printSwitchCaseListNode(x.next);
    }
	
	// ------------------------- comando switchcase -----------------------
    public void numberSwitchCaseNode(SwitchCaseNode x) {//ok
        if (x == null) {
            return;
        }
	...
	// -------------------------- Literal inteira ----------------------
    public void numberIntLitNode(IntLitNode x) {
        if (x == null) {
            return;
        }
    ...
    public void printIntLitNode(IntLitNode x) {
        if (x == null) {
            return;
        }

        System.out.println();
        System.out.print(x.number + ": IntLitNode ===> " + x.position.image);
    }
	...
	// ------------------------ Literal string ----------------------------
    public void numberStringLitNode(StringLitNode x) {
        if (x == null) {
            return;
        }
    ...
    public void printStringLitNode(StringLitNode x) {
        if (x == null) {
            return;
        }

        System.out.println();
        System.out.print(x.number + ": StringLitNode ===> " +
            x.position.image);
    }
	
	// ------------------------ Literal float ----------------------------
    public void numberFloatLitNode(FloatLitNode x) {
        if (x == null) {
            return;
        }
    ...
    public void printFloatLitNode(FloatLitNode x) {
        if (x == null) {
            return;
        }

        System.out.println();
        System.out.print(x.number + ": FloatLitNode ===> " +
            x.position.image);
    }
	
	// ------------------------ Literal char ----------------------------
    public void numberCharLitNode(CharLitNode x) {
        if (x == null) {
            return;
        }
    ...
    public void printCharLitNode(CharLitNode x) {
        if (x == null) {
            return;
        }

        System.out.println();
        System.out.print(x.number + ": CharLitNode ===> " +
            x.position.image);
    }
	
	// ------------------------ Literal double ----------------------------
    public void numberDoubleLitNode(DoubleLitNode x) {
        if (x == null) {
            return;
        }
    ...
    public void printDoubleLitNode(DoubleLitNode x) {
        if (x == null) {
            return;
        }

        System.out.println();
        System.out.print(x.number + ": DoubleLitNode ===> " +
            x.position.image);
    }
	
	// ------------------------ Literal boolean ----------------------------
    public void numberBooleanLitNode(BooleanLitNode x) {
        if (x == null) {
            return;
        }
    ...
    public void printBooleanLitNode(BooleanLitNode x) {
        if (x == null) {
            return;
        }

        System.out.println();
        System.out.print(x.number + ": BooleanLitNode ===> " +
            x.position.image);
    }
    ...
    public void printExpreNode(ExpreNode x) {
        ...
        } else if (x instanceof IntLitNode) {
            printIntLitNode((IntLitNode) x);
        } else if (x instanceof StringConstNode) {
            printStringConstNode((StringConstNode) x);
        } else if (x instanceof StringLitNode) {
            printStringLitNode((StringLitNode) x);
        } else if (x instanceof FloatLitNode) {
            printFloatLitNode((FloatLitNode) x);
        } else if (x instanceof CharLitNode) {
            printCharLitNode((CharLitNode) x);
        } else if (x instanceof DoubleLitNode) {
            printDoubleLitNode((DoubleLitNode) x);
        } else if (x instanceof BooleanLitNode) {
            printBooleanLitNode((BooleanLitNode) x);
    ...
    public void numberExpreNode(ExpreNode x) {
        if (x instanceof NewObjectNode) {
            ...
            numberIntLitNode((IntLitNode) x);
        } else if (x instanceof StringConstNode) {
            numberStringConstNode((StringConstNode) x);
        } else if (x instanceof StringLitNode) {
            numberStringLitNode((StringLitNode) x);
        } else if (x instanceof FloatLitNode) {
            numberFloatLitNode((FloatLitNode) x);
        } else if (x instanceof CharLitNode) {
            numberCharLitNode((CharLitNode) x);
        } else if (x instanceof DoubleLitNode) {
            numberDoubleLitNode((DoubleLitNode) x);
        } else if (x instanceof BooleanLitNode) {
            numberBooleanLitNode((BooleanLitNode) x);
        } else if (x instanceof NullConstNode) {
